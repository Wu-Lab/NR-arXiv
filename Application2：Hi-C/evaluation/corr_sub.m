function score=corr_sub(contact_mat1,contact_mat2,sub_window_size)

n=length(contact_mat1);
n_sub_region=n-sub_window_size+1;
corr_vec=zeros(1,n_sub_region);

for i=1:n_sub_region
    region_left=i;
    region_right=region_left+sub_window_size-1;
