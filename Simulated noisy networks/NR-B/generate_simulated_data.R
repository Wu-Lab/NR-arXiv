...
for (i in 1:length(noisy_proportion)){
  for (j in 1:loops){
    ...
    write.csv(A1,paste0('./simudata_BA/true_',i,'_loop_',j,'.csv'))
    ...
    write.csv(A2,paste0('./simudata_BA/noisy_',i,'_loop_',j,'.csv'))
  }
}

#8200 files are generated, 4100 for real and 4100 for noisy
#4100 : 41 noise intensities at 100 plots each
